...
> 이번 프로젝트를 통해 AI를 빠르게 활용하는 것만큼, 먼저 이해하고 설계하고 검증하는 과정이 중요하다는 점을 팀 전체가 분명하게 체감했습니다.

**김동현**

- 개념을 먼저 깊이 학습한 덕분에 AI 산출물의 품질을 더 높이고, 디테일한 기능 검증까지 주도적으로 진행할 수 있었습니다.
- PR에 목적과 테스트 결과를 명확히 남기는 협업 규칙이 팀 히스토리를 파악하는 데 큰 도움이 됐습니다.
- `main` 브랜치 직접 병합의 아찔한 경험을 통해, 안전한 브랜치 전략의 중요성을 확실히 배웠습니다.

**황정연**

- AI 코드가 블랙박스로 느껴지는 한계를 줄이기 위해 구현 로드맵을 먼저 세운 것이 전체 흐름을 이해하는 데 큰 도움이 됐습니다.
- AI에만 의존하지 않고 기초 골격을 직접 구현해보면서 설계와 로직에 대한 이해도를 더 높일 수 있었습니다.

**정범진**

- Codex 사용 과정의 시행착오를 거치며 도구 활용 감각을 익혔고, 팀원들과의 대화를 통해 잘못 이해한 개념도 빠르게 바로잡을 수 있었습니다.
- 앞으로는 내가 이해한 내용을 더 논리적이고 명확하게 설명하는 커뮤니케이션 역량을 키우는 것이 중요한 성장 목표라고 느꼈습니다.
