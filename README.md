...
이번 프로젝트를 통해 AI를 빠르게 활용하는 것만큼이나 **'먼저 이해하고, 설계하고, 검증하는 과정'**이 훨씬 중요하다는 점을 깊이 체감했습니다. 

* **AI 블랙박스 극복과 주도적인 설계**
    AI가 작성한 코드에 수동적으로 끌려다니지 않기 위해, 우리는 코딩 전 관련 개념을 깊이 학습하고 전체적인 구현 로드맵을 먼저 세웠습니다. AI에만 의존하지 않고 기초 골격을 직접 구현해보며 로직을 꼼꼼히 검증한 결과, 전체적인 코드 이해도를 높이고 AI 산출물의 퀄리티 또한 크게 향상시킬 수 있었습니다.

* **투명한 히스토리 관리와 안전한 브랜치 전략**
    협업의 효율을 높이기 위해 PR 작성 시 작업 목적과 테스트 결과를 명확히 기록하는 규칙을 도입했고, 덕분에 다른 사람의 코드를 보지 않고도 팀 전체의 작업 히스토리를 쉽게 파악할 수 있었습니다. 또한 `main` 브랜치 직접 병합이라는 아찔한 시행착오를 겪으며, 안전하고 체계적인 브랜치 관리 전략의 중요성을 뼈저리게 배웠습니다.

* **도구 적응과 동료 학습 (Peer Learning)의 가치**
    Codex 등 AI 도구에 적응하며 겪은 시행착오를 공유하고, 자신이 잘못 이해했던 개념들을 팀원들과의 적극적인 소통을 통해 빠르게 바로잡을 수 있었습니다.
